...
INSERT INTO `t_admin_admin` VALUES (1,'admin','a5064e08c2ccd3fb0257bb4a9af4a29f','145963','超级管理员',1,1,'18687460581');
...
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COMMENT='后台管理员登录日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_admin_auth_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='用户组表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_admin_auth_group` VALUES (1,0,'超级管理员',1,'',0,1426881003,1427552428),(2,0,'信息管理员',1,'',2,1483065464,1483411390),(3,2,'信息发布员',1,'',0,1483065492,1483065492),(4,3,'一组发布员',1,'',0,1483067746,1483067746);
...
-- Dump completed on 2017-01-22 17:59:55
